...
-- 添加混合检索配置字段
ALTER TABLE "knowledge_bases" ADD COLUMN IF NOT EXISTS "vectorWeight" DOUBLE PRECISION NOT NULL DEFAULT 0.7;
ALTER TABLE "knowledge_bases" ADD COLUMN IF NOT EXISTS "rrfK" INTEGER NOT NULL DEFAULT 60;
